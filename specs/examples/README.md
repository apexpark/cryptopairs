...
Example payloads used for validation, tests, and documentation.
...
- `specs/examples/data_market_metrics_response.example.json`
- `specs/examples/kraken_history_depth_probe_PI_XBTUSD.json`
...
- `specs/examples/execution_paper_order_intent_response.example.json`
...
- `specs/examples/strategy_trade_now_observability_response.example.json`
