...
beforeEach(() => {
  ...
  api.fetchStrategyTradeNow.mockResolvedValue({
    generated_at: "2026-02-20T00:00:00Z",
    timeframe_filter: "1m",
    learning_overlay_generated_at: "2026-02-20T00:00:00Z",
    learning_overlay_age_seconds: 120,
    ...
    tradable_now: [
      {
        ...
        portfolio_target_weight: 0.35,
        portfolio_risk_contribution: 0.2,
        approval_source: "LEARNING_SELECTION",
        requires_fresh_overlay: false,
        learning_recommendation: "PROMOTE",
        learning_trade_eligible: true,
        learning_selection_selected: true,
        learning_reason_codes: ["LEARNING_SELECTION_SELECTED"],
        learning_cycle_generated_at: "2026-02-20T00:00:00Z",
        selected_config_source: "AUTO_CHAMPION",
        legacy_fallback_active: false,
        decision_bucket: "TRADE_NOW",
        decision_reason_code: "LEARNING_SELECTED_AND_LIVE_GATES_PASS",
        blocked_reason_code: null,
        watch_reason_code: null,
        rationale_codes: ["APPROVAL_SOURCE_LEARNING_SELECTION", "NON_LEGACY_CHAMPION"],
      },
    ],
    watchlist: [],
    excluded: [],
