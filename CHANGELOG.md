...
### Added
- Added strict Slice A async reoptimization run contracts and examples for enqueue, status, cancel, and artifact manifest responses without changing existing `/v1/strategy/pairs/reoptimize` semantics.
