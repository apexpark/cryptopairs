...
| AUTO-2B.2 - Full-universe selector-view design | **Merged** | claude | PR #249 at `c1eaf79` (Operator-approved per AUTO-2 §6). Implementation B2-a..d awaits Operator go + §8 answers (bucket scope, cadence, disk budget). |
